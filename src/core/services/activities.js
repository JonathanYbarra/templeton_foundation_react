export const monthlySeminars = [
  {
    id: 1,
    pdfPresentation: "/pdfs/activities/pruebaPDF.pdf",
...
export const talksForGeneralPublic = [
  {
    id: 1,
    pdfPresentation: null,
    title: "Pluralismo ontológico",
    description:
      "Pluralismo ontológico, qué es lo que hay en un mundo sin certezas. Charla invitada en las II Jornadas de Fundamentos y Aplicaciones de la Interdisciplina, Buenos Aires, 19 al 22 de Abril de 2021.",
    directedBy: "Seminar dictated by Olimpia Lombardi",
    date: "Pluralismo ontológico",
  },
  {
    id: 2,
    pdfPresentation: "https://www.youtube.com/watch?v=qs5eUECjWQE&t=177s&ab_channel=InstitutodeNanosistemasUNSAM-",
    title: "Los múltiples mundos de la ciencia",
    description:
      "Los múltiples mundos de la ciencia, Conferencia en el ciclo de seminarios Historia y Filosofía de la Ciencia, Universidad Nacional de San Martín, 21 de octubre de 2020.",
    directedBy: "Seminar dictated by Olimpia Lombardi",
    date: "Los múltiples mundos de la ciencia",
  },
];
